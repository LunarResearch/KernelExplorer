...
1. Unzip the driver `kprocesshacker.7z` (fucking Google blocks the transfer of drivers through Google Drive).
2. Please rename `KernelExplorer.exe_RenameMe` to `KernelExplorer.exe`, and `UI0Detect.exe_RenameMe` to `UI0Detect.exe`.
